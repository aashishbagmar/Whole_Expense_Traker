...
class Category(models.Model):
    ...
    class Meta:
        unique_together = ('user', 'name')  # Each user can have their own categories
...
class Transaction(models.Model):
    ...
    class Meta:
        indexes = [
            ...
            models.Index(fields=['user', 'category_type'], name='user_cattype_idx'),
            models.Index(fields=['user', 'category', 'date'], name='user_cat_date_idx'),
...
class CategoryCorrection(models.Model):
    """Stores AI category prediction corrections for adaptive learning."""
    user = models.ForeignKey(User, on_delete=models.CASCADE)
    ...
    def __str__(self):
        return f"{self.user.username} - {self.ai_predicted_category} → {self.user_corrected_category}"
